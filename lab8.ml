...
......................................................................*)
  ...
  let add_listener (evt : 'a event) (listener : 'a -> unit) : id =
    let temp = new_id() in
    evt := {id = temp; action = listener} :: !evt; temp
(*......................................................................
...
......................................................................*)
  ...
  let remove_listener (evt : 'a event) (i : id) : unit =
     let rec inner  (evti : 'a waiter list) (ii : id) : 'a waiter list =
       match evti with
       |[] -> []
       |{id = x; action = y} :: t ->  if x = ii then inner t ii
         else {id = x; action = y} :: inner t ii
     in
     evt := inner !evt i 
...
......................................................................*)
  ...
  let rec fire_event (evt : 'a event) (arg : 'a) : unit =
    match !evt with
    |[] -> ()
    |{id = x; action = y} :: t -> y arg; fire_event (ref t) arg
...
newswire event.
......................................................................*)
let fNNid = WEvent.add_listener newswire fakeNewsNetwork;;
...
......................................................................*)
WEvent.remove_listener newswire fNNid;;
